...
class _PortfolioPageState extends State<PortfolioPage> {
  ...
  Widget _buildSkillsSection() {
    final skills = <String>[
      'Web Development', 'Photography', 'Flutter', 'HTML & CSS', 'JavaScript', 'UI/UX Design',
    ];
    return Padding(
      ...
      child: ListView(
        ...
        children: [
          _buildProjectCard(
            ...
            description: 'A web app that helps users build and track their skincare routines with smart reminders.',
            onViewDemo: () => _launchUrl(_project1Url),
          ),
          _buildProjectCard(
            imagePath: 'assets/images/project2.png',
            title: 'TableWork - Task Management Dashboard',
            description: 'A task management dashboard designed for productivity, allowing users to efficiently organize their work.',
            onViewDemo: () => _launchUrl(_project2Url),
          ),
          _buildProjectCard(
            imagePath: 'assets/images/project3.png',
            title: 'EduPlay - Math Puzzle Game',
            description: 'An interactive math puzzle game for kids that makes learning algebra an engaging experience.',
            onViewDemo: () => _launchUrl(_project3Url),
          ),
          _buildProjectCard(
          imagePath: 'assets/images/project4.png',
          title: 'TimeBlock Pro - Personal Academy Schedule',
          description: 'Optimize your semester! This app provides a consolidated view of your class schedule, ensuring you never miss a lecture. Includes one-click access to all relevant course WhatsApp chats.',
      ...
      child: Column(
        children: [
          ...
          ElevatedButton(
            ...
            child: const Text(
              'Send an Email',
              style: TextStyle(fontWeight: FontWeight.bold, color: Color(0xFF020617), fontSize: 16),
            ),
          ),
        ],
      ),
...
// Widget untuk bagian footer
// Widget untuk bagian footer
// KODE INI MENGGUNAKAN FontAwesomeIcons
Widget _buildFooter() {
  return Padding(
